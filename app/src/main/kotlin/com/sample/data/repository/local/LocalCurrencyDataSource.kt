...
@Database(
        ...
        version = 1)
abstract class LocalCurrencyDataSource : RoomDatabase() {

    abstract fun currencyDao(): LocalCurrencyDao

    companion object {

        fun buildPersistentCurrency(context: Context): LocalCurrencyDataSource = Room.databaseBuilder(
                context.applicationContext,
                LocalCurrencyDataSource::class.java,
                LocalContract.DATABASE_CURRENCY
        ).build()
